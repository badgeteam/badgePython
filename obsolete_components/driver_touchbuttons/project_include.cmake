...
set(mods
    "${COMPONENT_DIR}/modtouchbuttons.c"
)

#Define the name of your module here
set(mod_name "touchbuttons")
set(mod_register "touchbuttons")

if(CONFIG_DRIVER_IO_TOUCHBUTTONS_ENABLE)
    message(STATUS "touchbuttons enabled")
    ...
    message(STATUS "touchbuttons disabled")
endif()