...
freeze("../python_modules/common", ("interface.py", "rtc.py", "upysh.py", "valuestore.py", "shell.py", "term.py", "term_menu.py", "virtualtimers.py", "wifi.py", "system.py", "ntp.py", "_boot.py", "boot.py", "audio.py"))
