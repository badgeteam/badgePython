...
static mp_obj_t neopixels_enable(size_t n_args, const mp_obj_t *args) {
	...
	return mp_obj_new_int(driver_neopixel_enable(pin));
}
...
static MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(neopixels_enable_obj,  0, 1, neopixels_enable  );
